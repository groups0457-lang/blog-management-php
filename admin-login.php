...
<head>
    ...
    <title>Creative Admin Login</title>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css"/>  <link rel="icon" type="image/png" href="profile.png?v=1">

    
    <style>
        /* Creative Design Styles (Consistent with index.html) */
        body {
        ...
        .btn-creative:hover {
            ...
            box-shadow: 0 8px 25px 0 rgba(35, 166, 213, 0.4);
        }
...
<body>
    ...
    <div class="container text-center">
        ...
        <form class="glass-form mx-auto" action="admin/admin-login.php" method="post">
